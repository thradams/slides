...
var hljs = function ()
{
            ...
            } function E(e, n, r, s)
            {
                ...
                let m = {}; function w(t, s)
                {
                    ...
                    ; if (!y) throw K(a.replace("{}", e)), Error('Unknown language: "' + e + '"')
                        ; const _ = V(y); let v = "", O = s || _; const N = {}, M = new g.__emitter(g); (() =>
                        {
                            const e = []
    ...
    ; "object" == typeof exports && "undefined" != typeof module && (module.exports = hljs);/*! `c` grammar compiled for Highlight.js 11.5.1 */
(() =>
{
    var e = (() =>
    {
        "use strict"; return e =>
        {
            const n = e.regex, t = e.COMMENT("//", "$", {
                ...
                keyword: ["typeid", "try", "catch", "throw", "repeat", "_Defer", "defer", "asm", "auto", "break", "case", "continue", "default", "do", "else", "enum", "extern", "for", "fortran", "goto", "if", "inline", "register", "restrict", "return", "sizeof", "struct", "switch", "typedef", "union", "volatile", "while", "_Alignas", "_Alignof", "_Atomic", "constexpr", "_Countof", "_Generic", "nullptr", "_Noreturn", "_Static_assert", "_Thread_local", "alignas", "alignof", "noreturn", "static_assert", "thread_local", "_Pragma", "_View", "_Opt", "_Out", "_Owner", "_Implicit", "_Obj_owner", "_Ctor", "_View", "_Dtor", "static_set", "static_state", "static_debug", "assert", "mutable"],
                type: ["typeof", "typeof_unqual", "float", "double", "signed", "unsigned", "int", "short", "long", "char", "void", "_Bool", "_Complex", "_Imaginary", "_Decimal32", "_Decimal64", "_Decimal128", "const", "static", "complex", "bool", "imaginary"],
